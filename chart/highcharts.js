...
(function () {
  ...
  function Ba(a, b, c, d) {
    ...
    return e !== Ba
      ...
      : j +
          (l ? k.substr(0, l) + f : "") +
          k.substr(l).replace(/(\d{3})(?=\d)/g, "$1" + f) +
          (h
            ? i +
              Q(g - k)
                .toFixed(h)
  ...
  var ib = M.adapterRun,
    ...
    jb = M.animate,
    bb = M.stop,
    M = { enabled: !0, x: 0, y: 15, style: { color: "#606060", cursor: "default", fontSize: "11px" } };
  E = {
    ...
    global: { useUTC: !0, canvasToolsURL: "http://code.highcharts.com/4.0.4/modules/canvas-tools.js", VMLRadialGradientURL: "http://code.highcharts.com/4.0.4/gfx/vml-radial-gradient.png" },
    chart: {
      borderColor: "#4572A7",
      borderRadius: 0,
    ...
    ya = function (a) {
      ...
      (function (a) {
        a && a.stops
          ...
          : (c = Wb.exec(a)) && (b = [y(c[1]), y(c[2]), y(c[3]), 1]);
      })(a);
      return {
        get: function (c) {
          var f;
    ...
    shadow: function (a, b, c) {
      ...
      if (a) {
        ...
        for (e = 1; e <= i; e++) {
          f = g.cloneNode(0);
          h = i * 2 + 1 - 2 * e;
          F(f, { isShadow: "true", stroke: a.color || "black", "stroke-opacity": j * e, "stroke-width": h, transform: "translate" + k, fill: P });
  ...
  ta.prototype = {
    ...
    init: function (a, b, c, d, e) {
      ...
      this.alignedObjects = [];
      this.url =
        (Ua || tb) && x.getElementsByTagName("base").length
          ? f.href
              .replace(/#.*?$/, "")
              .replace(/([\('\)])/g, "\\$1")
              .replace(/ /g, "%20")
                  ...
                  if (l)
                    for (var e = e.replace(/([^\^])-/g, "$1- ").split(" "), m = g.length > 1 || (e.length > 1 && k.whiteSpace !== "nowrap"), q, D, s = k.HcHeight, t = [], u = Y(o), Lb = 1; m && (e.length || t.length); )
                      delete a.bBox,
                        (q = a.getBBox()),
                        (D = q.width),
                        !ba && c.forExport && (D = c.measureSpanWidth(o.firstChild.data, a.styles)),
                        (q = D > l),
                        !q || e.length === 1
                          ? ((e = t),
                            (t = []),
                            e.length && (Lb++, s && Lb * u > s ? ((e = ["..."]), a.attr("title", a.textStr)) : ((o = x.createElementNS(xa, "tspan")), F(o, { dy: u, x: j }), p && F(o, "style", p), b.appendChild(o))),
                            D > l && (l = D))
                          : (o.removeChild(o.firstChild), t.unshift(e.pop())),
    ...
    rect: function (a, b, c, d, e, f) {
      var e = da(a) ? a.r : e,
        ...
        a = da(a) ? a : a === u ? {} : { x: a, y: b, width: t(c, 0), height: t(d, 0) };
    ...
    label: function (a, b, c, d, e, f, g, h, i) {
      function j() {
        ...
        if (y) {
          ...
          p.isImg || p.attr(r({ width: v(m.width), height: v(m.height) }, z));
          z = null;
        }
      }
      function k() {
        ...
        return r(e, {
          ...
          getCSS: function (a) {
            var b = a.element,
              ...
              b = e + this.width,
              f = d + this.height,
              d = { clip: "rect(" + v(a ? e : d) + "px," + v(a ? f : b) + "px," + v(a ? b : f) + "px," + v(a ? d : e) + "px)" };
  ...
  Ta.prototype = {
    addLabel: function () {
      ...
      this.isFirst = k;
      this.isLast = l;
      b = a.labelFormatter.call({ axis: a, chart: c, isFirst: k, isLast: l, dateTimeLabelFormat: n, value: a.isLog ? ea(ka(f)) : f });
  ...
  K.PlotLineOrBand.prototype = {
    render: function () {
      ...
      if (s(J)) r.zIndex = J;
      if (m)
        if (o) m.animate({ d: o }, null, m.onGetPath);
        else {
          if (
            (m.hide(),
            (m.onGetPath = function () {
              m.show();
            }),
            g)
          )
      ...
      if (f && s(f.text) && o && o.length && b.width > 0 && b.height > 0) {
        ...
        o = Oa(b);
        c = Oa(k);
        g.align(f, !1, { x: o, y: c, width: Ca(b) - o, height: Ca(k) - c });
        g.show();
      } else g && g.hide();
      return a;
    },
  ...
  na.prototype = {
    ...
    setTickPositions: function (a) {
      var b = this,
        ...
        J = b.categories;
      j
        ? ((b.linkedParent = c[b.coll][d.linkedTo]), (c = b.linkedParent.getExtremes()), (b.min = p(c.min, c.dataMin)), (b.max = p(c.max, c.dataMax)), d.type !== b.linkedParent.options.type && ha(11, 1))
      ...
      b.min === b.max || b.min === void 0 || b.max === void 0
        ? (b.tickInterval = 1)
        : j && !m && Y === b.linkedParent.options.tickPixelInterval
        ? (b.tickInterval = b.linkedParent.tickInterval)
        : ((b.tickInterval = p(m, J ? 1 : ((b.max - b.min) * Y) / t(b.len, Y))), !s(m) && b.len < Y && !this.isRadial && !this.isLog && !J && e && f && ((D = !0), (b.tickInterval /= 4)));
      i &&
        !a &&
        q(b.series, function (a) {
      ...
      if (!a)
        !b.ordinalPositions && (b.max - b.min) / b.tickInterval > t(2 * b.len, 200) && ha(19, !0),
          (a = h
            ? b.getTimeTicks(b.normalizeTimeTickInterval(b.tickInterval, d.units), b.min, b.max, d.startOfWeek, b.ordinalPositions, b.closestPointRange, !0)
            : g
            ? b.getLogTickPositions(b.tickInterval, b.min, b.max)
            : b.getLinearTickPositions(b.tickInterval, b.min, b.max)),
          D && a.splice(1, a.length - 2),
          (b.tickPositions = a);
      if (!j)
        (d = a[0]),
          (g = a[a.length - 1]),
  ...
  na.prototype.getLogTickPositions = function (a, b, c, d) {
    ...
    if (a >= 0.5) (a = v(a)), (g = this.getLinearTickPositions(a, b, c));
      ...
      (a = nb(a, null, mb(a))),
      (g = Va(this.getLinearTickPositions(a, b, c), za)),
      !d)
    )
      ...
      if (this.selectionMarker) {
        ...
        if (this.hasDragged || c)
          q(b.axes, function (b) {
            ...
            j &&
              I(b, "selection", d, function (a) {
                b.zoom(r(a, c ? { animation: !1 } : null));
              });
        this.selectionMarker = this.selectionMarker.destroy();
        c && this.scaleGroups();
      }
      if (b) B(b.container, { cursor: b._cursor }), (b.cancelClick = this.hasDragged > 10), (b.mouseIsDown = this.hasDragged = this.hasPinched = !1), (this.pinchDown = []);
    },
    ...
    onContainerClick: function (a) {
      ...
      b.cancelClick ||
        (c && this.inClass(a.target, "highcharts-tracker")
          ? (I(c.series, "click", r(a, { point: c })), b.hoverPoint && c.firePointEvent("click", a))
          : (r(a, this.getCoordinates(a)), b.isInsidePlot(a.chartX - d, a.chartY - e) && I(b, "click", a)));
    },
  ...
  lb.prototype = {
    ...
    renderItem: function (a) {
      ...
      if (!r) {
        ...
        a.legendItem = r = c
          .text(d.labelFormat ? Ja(d.labelFormat, a) : d.labelFormatter.call(a), l ? f + g : -g, this.baseline || 0, u)
          .css(w(a.visible ? h : i))
        ...
        if (i) {
          ...
          (a.box = i =
            c
              ...
              .attr({ stroke: j.borderColor, "stroke-width": l || 0, fill: n || P })
              .add(d)
              .shadow(j.shadow)),
            (i.isNew = !0);
        i[f ? "show" : "hide"]();
  ...
  (/Trident\/7\.0/.test(wa) || Ua) &&
    Na(lb.prototype, "positionItem", function (a, b) {
      var c = this,
        d = function () {
  ...
  Ya.prototype = {
    ...
    cloneRenderTo: function (a) {
      ...
      a
        ...
        : (c && c.parentNode === this.renderTo && this.renderTo.removeChild(c),
          ...
          B(b, { position: "absolute", top: "-9999px", display: "block" }),
    ...
    drawChartBox: function () {
      ...
      m = i + (a.shadow ? 8 : 0);
      if (i || j)
        if (e) e.animate(e.crisp({ width: c - m, height: d - m }));
        else {
          e = { fill: j || P };
    ...
    isReadyToRender: function () {
      var a = this;
      return (!ba && G == G.top && x.readyState !== "complete") || (ga && !G.canvg)
        ? (ga
            ? Mb.push(function () {
                a.firstRender();
  ...
  O.prototype = {
      ...
      if (d !== !1 && h && g === h && !e.cropped && !e.hasGroupedData)
        ...
        if (o && h > o) {
          ...
          if (ja(k)) {
            ...
            if (s) for (c = 0; c < h; c++) (i = a[c]), (r[c] = i[0]), (t[c] = i.slice(1, s + 1));
    ...
    translate: function () {
      ...
      this.generatePoints();
      for (
        var a = this.options, b = a.stacking, c = this.xAxis, d = c.categories, e = this.yAxis, f = this.points, g = f.length, h = !!this.modifyValue, i = a.pointPlacement, j = i === "between" || ja(i), k = a.threshold, a = 0;
        a < g;
        a++
      ) {
        var l = f[a],
    ...
    animate: function (a) {
      ...
      a
        ? ((a = b[g]),
          (d = b[g + "m"]),
          a || ((b[g] = a = c.clipRect(r(e, { width: 0 }))), (b[g + "m"] = d = c.clipRect(-99, f ? -b.plotLeft : -b.plotTop, 99, f ? b.chartWidth : b.chartHeight))),
          this.group.clip(a),
          this.markerGroup.clip(d),
          (this.sharedClipKey = g))
        : ((a = b[g]) && a.animate({ width: b.plotSizeX }, d), b[g + "m"] && b[g + "m"].animate({ width: b.plotSizeX + 99 }, d), (this.animate = null));
    },
      ...
      if (l.enabled !== !1 || this._hasPointMarkers)
        for (f = b.length; f--; )
          if (
            ...
            (m = g.marker || {}),
            (o = !!g.marker),
            (a = (s && m.enabled === u) || m.enabled),
            (q = c.isInsidePlot(v(d), e, c.inverted)),
            ...
            if (((a = g.pointAttr[g.selected ? "select" : ""] || n), (h = a.r), (i = p(m.symbol, this.symbol)), (j = i.indexOf("url") === 0), k))
              ...
              if (q && (h > 0 || j))
                g.graphic = c.renderer
                  .symbol(i, d - h, e - h, 2 * h, 2 * h, o ? m : l)
                  .attr(a)
                  .add(t);
            }
  ...
  r(Ya.prototype, {
    ...
    showLoading: function (a) {
      ...
      if (!d) (b.loadingDiv = d = $(Ka, { className: "highcharts-loading" }, r(e.style, { zIndex: 10, display: P }), b.container)), (b.loadingSpan = $("span", null, e.labelStyle, d)), N(b, "redraw", f);
      ...
      q(f, function (d) {
        ...
        f
          ...
          : (a[e] = a.chart.renderer
              .path(b)
              .attr({ fill: p(d[2], ya(d[1]).setOpacity(p(c.fillOpacity, 0.75)).get()), zIndex: 0 })
              .add(a.group));
      });
    },
  ...
  ia = ma(O, {
      ...
      q(a.points, function (h) {
        ...
        if (i !== u && !isNaN(i) && h.y !== null)
          (f = h.shapeArgs),
            ...
            j
              ? (bb(j), j.attr(i)[b.pointCount < e ? "animate" : "attr"](w(f)))
    ...
    animate: function (a) {
      ...
      if (ba)
        a
          ? ((e.scaleY = 0.001), (a = L(b.pos + b.len, t(b.pos, b.toPixels(c.threshold)))), d ? (e.translateX = a - b.len) : (e.translateY = a), this.group.attr(e))
        ...
        q(e, function (b) {
          ...
          if (h && !e) b.dataLabel = h.destroy();
            ...
            if (h)
              ...
              h = b.dataLabel = a.chart.renderer[e ? "text" : "label"](i, 0, -999, null, null, null, d.useHTML)
                .attr(h)
  ...
  O.prototype.alignDataLabel = function (a, b, c, d, e) {
    ...
    if ((a = this.visible && (a.series.forceDL || f.isInsidePlot(h, v(i), g) || (d && f.isInsidePlot(h, g ? d.x + 1 : d.y + d.height - 1, g)))))
      (d = r({ x: g ? f.plotWidth - i : h, y: v(g ? f.plotHeight - h : i), width: 0, height: 0 }, d)),
        r(c, { width: j.width, height: j.height }),
        c.rotation
          ? b[e ? "attr" : "animate"]({ x: d.x + c.x + d.width / 2, y: d.y + c.y + d.height / 2 }).attr({ align: c.align })
            ...
            s &&
              ...
              q(this.points, function (b) {
                ...
                if ((u = b.dataLabel) && u._pos)
                  (I = u._attr.visibility),
                    (y = u.connX),
                    (B = u.connY),
                    (k = l ? ["M", y + (x[6] === "left" ? 5 : -5), B, "C", y, B, 2 * x[2] - x[4], 2 * x[3] - x[5], x[2], x[3], "L", x[4], x[5]] : ["M", y + (x[6] === "left" ? 5 : -5), B, "L", x[2], x[3], "L", x[4], x[5]]),
                    j
                      ? (j.animate({ d: k }), j.attr("visibility", I))
                      : (b.connector = j =
                          a.chart.renderer
                            .path(k)
                            .attr({ "stroke-width": g, stroke: e.connectorColor || b.color || "#606060", visibility: I })
  ...
  T = K.TrackerMixin = {
    ...
    drawTrackerGraph: function () {
      ...
      j
        ...
        : ((a.tracker = h
            .path(d)
            .attr({ "stroke-linejoin": "round", visibility: a.visible ? "visible" : "hidden", stroke: o, fill: c ? o : P, "stroke-width": b.lineWidth + (c ? 0 : 2 * i), zIndex: 2 })
            .add(a.group)),
  ...
  r(Ya.prototype, {
    ...
    pan: function (a, b) {
      ...
      q(b === "xy" ? [1, 0] : [1], function (b) {
        ...
        h.series.length && l > L(k.dataMin, k.min) && i < t(k.dataMax, k.max) && (h.setExtremes(l, i, !1, !1, { trigger: "pan" }), (e = !0));
  ...
  r(Fa.prototype, {
    ...
    setState: function (a, b) {
      ...
      if (!((a === this.state && !b) || (this.selected && a !== "select") || (f[a] && f[a].enabled === !1) || (a && (j || (h && i.enabled === !1))) || (a && l.states && l.states[a] && l.states[a].enabled === !1))) {
        if (this.graphic) (g = g && this.graphic.symbolName && o.r), this.graphic.attr(w(o, g ? { x: c - g, y: d - g, width: 2 * g, height: 2 * g } : {})), k && k.hide();
        else {
          if (a && i)
