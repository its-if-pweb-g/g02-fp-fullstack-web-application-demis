...
(function (f) {
  ...
  f.post = function (b, a, d) {
    var c,
      b = l("form", k({ method: "post", action: b, enctype: "multipart/form-data" }, d), { display: "none" }, j.body);
  ...
  p(A.prototype, {
    ...
    exportChart: function (b, a) {
      var b = b || {},
        ...
        d = this.getSVG(k({ chart: { borderRadius: 0 } }, d.chartOptions, a, { exporting: { sourceWidth: b.sourceWidth || d.sourceWidth, sourceHeight: b.sourceHeight || d.sourceHeight } })),
    ...
    contextMenu: function (b, a, d, c, f, h, g) {
      ...
      if (!i)
        (e[j] = i = l("div", { className: b }, { position: "absolute", zIndex: 1e3, padding: u + "px" }, e.container)),
          (w = l("div", null, p({ MozBoxShadow: "3px 3px 10px #888", WebkitBoxShadow: "3px 3px 10px #888", boxShadow: "3px 3px 10px #888" }, k.menuStyle), i)),
          (x = function () {
            v(i, { display: "none" });
            g && g.setState(0);
            e.openMenu = !1;
