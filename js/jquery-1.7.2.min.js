  ...
  (f.fn.css = function (a, c) {
    ...
    c.documentElement.currentStyle &&
      (bA = function (a, b) {
        ...
        f == null && g && (e = g[b]) && (f = e),
          bt.test(f) &&
            ((c = g.left), (d = a.runtimeStyle && a.runtimeStyle.left), d && (a.runtimeStyle.left = a.currentStyle.left), (g.left = b === "fontSize" ? "1em" : f), (f = g.pixelLeft + "px"), (g.left = c), d && (a.runtimeStyle.left = d));
        return f === "" ? "auto" : f;
      }),
    (by = bz || bA),
