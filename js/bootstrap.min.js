    ...
    (c.prototype = {
      ...
      close: function (b) {
        ...
        d || ((d = c.attr("href")), (d = d && d.replace(/.*(?=#[^\s]*$)/, ""))),
          ...
          e.trigger("close").removeClass("in"),
      ...
      slide: function (b, c) {
        ...
        return (
          !a.support.transition && this.$element.hasClass("slide")
            ? (this.$element.trigger("slide"), d.removeClass("active"), e.addClass("active"), (this.sliding = !1), this.$element.trigger("slid"))
            : (e.addClass(b),
              e[0].offsetWidth,
              d.addClass(g),
              e.addClass(g),
  ...
  !(function (a) {
    function b(b, c) {
      ...
      (this.options = a.extend({}, a.fn.scrollspy.defaults, c)),
        (this.$scrollElement = e.on("scroll.scroll.data-api", d)),
    ...
    (b.prototype = {
      ...
      show: function () {
        ...
        (e = c.find(".active a").last()[0]),
          b.trigger({ type: "show", relatedTarget: e }),
          (f = a(d)),
    ...
    (b.prototype = {
      ...
      lookup: function (b) {
        ...
        return (
          ...
          this.query
            ? ((d = a.grep(this.source, function (a) {
      ...
      listen: function () {
        this.$element.on("blur", a.proxy(this.blur, this)).on("keypress", a.proxy(this.keypress, this)).on("keyup", a.proxy(this.keyup, this)),
          (a.browser.webkit || a.browser.msie) && this.$element.on("keydown", a.proxy(this.keypress, this)),
