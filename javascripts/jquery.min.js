    ...
    p.extend({
      ...
      parseHTML: function (a, b, c) {
        ...
        return !a || typeof a != "string"
          ? null
          : (typeof b == "boolean" && ((c = b), (b = 0)), (b = b || e), (d = v.exec(a)) ? [b.createElement(d[1])] : ((d = p.buildFragment([a], b, c ? null : [])), p.merge([], (d.cacheable ? p.clone(d.fragment) : d.fragment).childNodes)));
      },
  ...
  (p.event = {
    add: function (a, c, d, e, f) {
      ...
      for (j = 0; j < c.length; j++) {
        (k = W.exec(c[j]) || []),
          ...
          (r = p.event.special[l] || {}),
          (n = p.extend({ type: l, origType: k[1], data: e, handler: d, guid: d.guid, selector: f, needsContext: f && p.expr.match.needsContext.test(f), namespace: m.join(".") }, o)),
          (q = i[l]);
        if (!q) {
    ...
    (function (a, b) {
      ...
      var c,
        ...
        _ = X(function (a) {
          return (
            (a.innerHTML = "<div class='hidden e'></div><div class='hidden'></div>"), !a.getElementsByClassName || !a.getElementsByClassName("e").length ? !1 : ((a.lastChild.className = "e"), a.getElementsByClassName("e").length === 2)
          );
        }),
        ba = X(function (a) {
        ...
        (e = bc.selectors =
          {
            ...
            preFilter: {
              ...
              CHILD: function (a) {
                return (
                  (a[1] = a[1].toLowerCase()), a[1] === "nth" ? (a[2] || bc.error(a[0]), (a[3] = +(a[3] ? a[4] + (a[5] || 1) : 2 * (a[2] === "even" || a[2] === "odd"))), (a[4] = +(a[6] + a[7] || a[2] === "odd"))) : a[2] && bc.error(a[0]), a
                );
              },
              PSEUDO: function (a) {
                var b, c;
    ...
    p.each(
      ...
      function (a, b) {
        p.fn[a] = function (c, d) {
          ...
          return (
            bc.test(a) || (d = c), d && typeof d == "string" && (e = p.filter(d, e)), (e = this.length > 1 && !bg[a] ? p.unique(e) : e), this.length > 1 && bd.test(a) && (e = e.reverse()), this.pushStack(e, a, k.call(arguments).join(","))
          );
        };
      }
    ),
          ...
          (g = f = null),
            k.length &&
              p.each(k, function (a, b) {
                b.src ? (p.ajax ? p.ajax({ url: b.src, type: "GET", dataType: "script", async: !1, global: !1, throws: !0 }) : p.error("no ajax")) : p.globalEval((b.text || b.textContent || b.innerHTML || "").replace(by, "")),
      ...
      ? (bH = function (b, c) {
          ...
          return (
            h &&
              ...
              bQ.test(d) && bO.test(c) && ((e = i.width), (f = i.minWidth), (g = i.maxWidth), (i.minWidth = i.maxWidth = i.width = d), (d = h.width), (i.width = e), (i.minWidth = f), (i.maxWidth = g))),
            d
          );
        })
      : e.documentElement.currentStyle &&
        (bH = function (a, b) {
          ...
          return (
            ...
            bQ.test(e) &&
              !bM.test(b) &&
              ((c = f.left), (d = a.runtimeStyle && a.runtimeStyle.left), d && (a.runtimeStyle.left = a.currentStyle.left), (f.left = b === "fontSize" ? "1em" : e), (e = f.pixelLeft + "px"), (f.left = c), d && (a.runtimeStyle.left = d)),
            e === "" ? "auto" : e
          );
        }),
