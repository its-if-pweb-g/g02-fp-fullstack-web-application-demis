...
(function (e) {
  ...
  e.post = function (a, b) {
    var c, d;
    d = m("form", { method: "post", action: a, enctype: "multipart/form-data" }, { display: "none" }, i.body);
  ...
  p(y.prototype, {
    getSVG: function (a) {
      ...
      a = m("div", null, { position: "absolute", top: "-9999em", width: b.chartWidth + "px", height: b.chartHeight + "px" }, i.body);
      d = b.renderTo.style.width;
      g = b.renderTo.style.height;
      d = f.exporting.sourceWidth || f.chart.width || (/px$/.test(d) && parseInt(d, 10)) || 600;
      g = f.exporting.sourceHeight || f.chart.height || (/px$/.test(g) && parseInt(g, 10)) || 400;
    ...
    exportChart: function (a, b) {
      var a = a || {},
        ...
        c = this.getSVG(k({ chart: { borderRadius: 0 } }, c.chartOptions, b, { exporting: { sourceWidth: a.sourceWidth || c.sourceWidth, sourceHeight: a.sourceHeight || c.sourceHeight } })),
        a = k(this.options.exporting, a);
      e.post(a.url, { filename: a.filename || "chart", type: a.type, width: a.width || 0, scale: a.scale || 2, svg: c });
    },
    print: function () {
      var a = this,
        b = a.container,
    ...
    contextMenu: function (a, b, c, d, e, g, f) {
      var h = this,
        ...
        s;
      if (!l)
        (h[A] = l = m("div", { className: "highcharts-" + a }, { position: "absolute", zIndex: 1e3, padding: k + "px" }, h.container)),
          (u = m("div", null, p({ MozBoxShadow: "3px 3px 10px #888", WebkitBoxShadow: "3px 3px 10px #888", boxShadow: "3px 3px 10px #888" }, q.menuStyle), l)),
          (j = function () {
            t(l, { display: "none" });
            f && f.setState(0);
            h.openMenu = !1;
    ...
    addButton: function (a) {
      ...
      if (a.enabled !== !1) {
        ...
        a.text && a.symbol ? (n.paddingLeft = e.pick(n.paddingLeft, 25)) : a.text || p(n, { width: a.width, height: a.height, padding: 0 });
        f = c.button(a.text, 0, 0, j, n, m, o).attr({ title: b.options.lang[a._titleKey], "stroke-linecap": "round" });
        a.symbol &&
          (g = c
    ...
    destroyExport: function (a) {
      var a = a.target,
        b,
        c;
      for (b = 0; b < a.exportSVGElements.length; b++) if ((c = a.exportSVGElements[b])) (c.onclick = c.ontouchstart = null), (a.exportSVGElements[b] = c.destroy());
