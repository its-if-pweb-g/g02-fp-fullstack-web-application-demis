...
(function () {
  ...
  function Eb(a, b, c, d) {
    ...
    if (t(b)) {
      ...
      b = 1;
      h = i[ab]();
      for (var d = i.getTime(), l = i[$a](), m = i[Sa](), o = g ? 0 : (864e5 + i.getTimezoneOffset() * 6e4) % 864e5; d < c; )
        e.push(d), j === H[ta] ? (d = bb(h + b * k, 0)) : j === H[Ra] ? (d = bb(h, l + b * k)) : !g && (j === H[sa] || j === H[Za]) ? (d = bb(h, l, m + b * k * (j === H[sa] ? 1 : 7))) : (d += j * k), b++;
      e.push(d);
      n(
        sb(e, function (a) {
  ...
  var ib = F.adapterRun,
    ...
    Ab = F.animate,
    Wa = F.stop,
    F = { enabled: !0, x: 0, y: 15, style: { color: "#666", cursor: "default", fontSize: "11px", lineHeight: "14px" } };
  M = {
    ...
    global: { useUTC: !0, canvasToolsURL: "http://code.highcharts.com/3.0.5/modules/canvas-tools.js", VMLRadialGradientURL: "http://code.highcharts.com/3.0.5/gfx/vml-radial-gradient.png" },
    chart: {
      borderColor: "#4572A7",
      borderRadius: 5,
  ...
  var pa = function (a) {
    ...
    (function (a) {
      a && a.stops
        ...
        ? (b = [A(c[1]), A(c[2]), A(c[3]), parseFloat(c[4], 10)])
        : (c = /#([a-fA-F0-9]{2})([a-fA-F0-9]{2})([a-fA-F0-9]{2})/.exec(a))
        ? (b = [A(c[1], 16), A(c[2], 16), A(c[3], 16), 1])
        : (c = /rgb\(\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*\)/.exec(a)) && (b = [A(c[1]), A(c[2]), A(c[3]), 1]);
    })(a);
    return {
      get: function (c) {
        var f;
  ...
  va.prototype = {
    ...
    attr: function (a, b) {
      ...
      if (ea(a)) (c = a), h === "circle" ? (c = { x: "cx", y: "cy" }[c] || c) : c === "strokeWidth" && (c = "stroke-width"), (q = w(g, c) || this[c] || 0), c !== "d" && c !== "visibility" && (q = parseFloat(q));
      else {
        for (c in a)
          if (((j = !1), (d = a[c]), (e = k[c] && k[c].call(this, d, c)), e !== !1)) {
            e !== v && (d = e);
            if (c === "d") d && d.join && (d = d.join(" ")), /(NaN| {2}|^$)/.test(d) && (d = "M 0 0");
            else if (c === "x" && h === "text") for (e = 0; e < g.childNodes.length; e++) (f = g.childNodes[e]), w(f, "x") === w(g, "x") && w(f, "x", d);
      ...
      if (this.added) {
        ...
        if (b.tagName === "SPAN") {
          ...
          if (r !== this.cTT) {
            ...
            y += q * m * (la ? 1 - h : h);
            V -= o * m * (j ? (la ? h : 1 - h) : 1);
            i && ((y -= k * h * (o < 0 ? -1 : 1)), j && (V -= l * h * (q < 0 ? -1 : 1)), L(b, { textAlign: g }));
            this.xCorr = y;
            this.yCorr = V;
          }
  ...
  Ga.prototype = {
    ...
    init: function (a, b, c, d) {
      ...
      this.alignedObjects = [];
      this.url =
        (gb || fb) && z.getElementsByTagName("base").length
          ? e.href
              .replace(/#.*?$/, "")
              .replace(/([\('\)])/g, "\\$1")
              .replace(/ /g, "%20")
        ...
        n(m, function (e) {
          if (e !== "" || m.length === 1) {
            ...
            if (
              ...
              p ? (o.dx = 0) : (o.x = i),
              w(n, o),
              !p && f && (!Z && d && L(n, { display: "block" }), w(n, "dy", l || c.fontMetrics(/px$/.test(n.style.fontSize) ? n.style.fontSize : j.fontSize).h, fb && n.offsetHeight)),
              b.appendChild(n),
              p++,
              k)
            )
              for (var e = e.replace(/([^\^])-/g, "$1- ").split(" "), t, u = []; e.length || u.length; )
                delete a.bBox,
                  (t = a.getBBox().width),
                  (o = t > k),
                  !o || e.length === 1
                    ? ((e = u), (u = []), e.length && ((n = z.createElementNS(xa, "tspan")), w(n, { dy: l || 16, x: i }), r && w(n, "style", r), b.appendChild(n), t > k && (k = t)))
                    : (n.removeChild(n.firstChild), u.unshift(e.pop())),
    ...
    button: function (a, b, c, d, e, f, g, h) {
      ...
      J(i.element, ra ? "mouseout" : "mouseleave", function () {
    ...
    color: function (a, b, c) {
      ...
      if (g) {
        ...
        h[o]
          ? (a = h[o].id)
          : ((c.id = a = "highcharts-" + yb++),
            (h[o] = i = d.createElement(g).attr(c).add(d.defs)),
            (i.stops = []),
            n(j, function (a) {
    ...
    label: function (a, b, c, d, e, f, g, h, i) {
      ...
      function k() {
        var a = q.styles,
          ...
          c;
        c = h ? 0 : w;
        if (t(Oa) && (a === "center" || a === "right")) b += { center: 0.5, right: 1 }[a] * (Oa - V.width);
  ...
  if (!Z && !$) {
        ...
        if (ea(a)) (c = a), (q = c === "strokeWidth" || c === "stroke-width" ? this.strokeweight : this[c]);
          ...
          for (c in a)
            if (((d = a[c]), (m = !1), (e = o[c] && o[c].call(this, d, c)), e !== !1 && d !== null)) {
              ...
              else if (oa(c, ["x", "y", "width", "height"]) !== -1)
      ...
      clip: function (a) {
        ...
        a
          ? ((c = a.members),
            ...
            (a = a.getCSS(b)))
          : (b.destroyClip && b.destroyClip(), (a = { clip: eb ? "inherit" : "rect(auto)" }));
        return b.css(a);
      },
    ...
    var ma = {
      ...
      invertChild: function (a, b) {
        var c = b.style;
        L(a, { flip: "x", left: A(c.width) - 1, top: A(c.height) - 1, rotation: -90 });
      },
      symbols: {
        arc: function (a, b, c, d, e) {
          var f = e.start,
        ...
        rect: function (a, b, c, d, e) {
          var f = a + c,
            ...
            h;
          !t(e) || !e.r
            ? (f = Ga.prototype.symbols.square.apply(0, arguments))
            : ((h = C(e.r, c, d)),
              (f = [
                "M",
                a + h,
  ...
  La.prototype = {
    ...
    render: function (a, b, c) {
      ...
      if (m && r)
        u === "inside" && (r = -r), d.opposite && (r = -r), (b = this.getMarkPath(I, G, r, m * B, g, f)), o ? o.animate({ d: b, opacity: c }) : (this.mark = f.path(b).attr({ stroke: t, "stroke-width": m, opacity: c }).add(d.axisGroup));
      if (i && !isNaN(I))
        (i.xy = G = this.getLabelPosition(I, G, i, g, k, E, a, s)),
  ...
  tb.prototype = {
    render: function () {
      ...
      if (h) {
        ...
        if (((j = r(j, b.min - d)), (i = C(i, b.max + d)), (q = b.getPlotBandPath(j, i, e)), (d = { fill: y }), e.borderWidth)) (d.stroke = e.borderColor), (d["stroke-width"] = e.borderWidth);
      } else return;
      if (t(u)) d.zIndex = u;
      if (o)
        q
          ? o.animate({ d: q }, null, o.onGetPath)
          : (o.hide(),
      ...
      if (f && t(f.text) && q && q.length && b.width > 0 && b.height > 0) {
        ...
        if (!g)
          a.label = g = v
            ...
            .attr({ align: f.textAlign || f.align, rotation: f.rotation, zIndex: u })
            .css(f.style)
            .add();
        b = [q[1], q[4], p(q[6], q[1])];
        q = [q[2], q[5], p(q[7], q[2])];
  ...
  db.prototype = {
    ...
    setTickPositions: function (a) {
      var b = this,
        ...
        q = b.categories;
      h
        ? ((b.linkedParent = c[g ? "xAxis" : "yAxis"][d.linkedTo]), (c = b.linkedParent.getExtremes()), (b.min = p(c.min, c.dataMin)), (b.max = p(c.max, c.dataMax)), d.type !== b.linkedParent.options.type && ja(11, 1))
        : ((b.min = p(b.userMin, d.min, b.dataMin)), (b.max = p(b.userMax, d.max, b.dataMax)));
      ...
      if (!a)
        (b.max - b.min) / b.tickInterval > 2 * b.len && ja(19, !0),
          (a = f
      ...
      if (o && o.text && o.enabled !== !1) {
        if (!a.axisTitle)
          (a.axisTitle = c
            ...
            .attr({ zIndex: 7, rotation: o.rotation || 0, align: o.textAlign || { low: "left", middle: "center", high: "right" }[o.align] })
            .css(o.style)
            .add(a.axisGroup)),
            (a.axisTitle.isNew = !0);
    ...
    render: function () {
      var a = this,
        ...
        p = d.lineWidth,
        y,
        r = b.hasRendered && t(a.oldMin) && !isNaN(a.oldMin);
      y = a.hasData;
      var u = a.showAxis,
        s,
        w;
      ...
      if (l) {
        ...
        for (d = l.length; d--; )
          if (((m = a.series), (e = m[d ? "yAxis" : "xAxis"]), l[d] && e))
            if (((h = d ? p(a.stackY, a.y) : a.x), e.isLog && (h = na(h)), m.modifyValue && (h = m.modifyValue(h)), (e = e.getPlotLinePath(h, 1)), this.crosshairs[d])) this.crosshairs[d].attr({ d: e, visibility: "visible" });
            else {
      ...
      if (!b.cancelClick)
        c && this.inClass(a.target, "highcharts-tracker")
          ? ((g = this.chartPosition),
            ...
            K(c.series, "click", s(a, { point: c })),
            b.hoverPoint && c.firePointEvent("click", a))
          : (s(a, this.getCoordinates(a)), b.isInsidePlot(a.chartX - d, a.chartY - e) && K(b, "click", a));
    },
  ...
  wb.prototype = {
    ...
    renderItem: function (a) {
      ...
      if (
        ...
        (a.legendItem = u =
          d
            .text(e.labelFormat ? Ba(e.labelFormat, a) : e.labelFormatter.call(a), m ? g + h : -h, b.baseline, v)
            .css(x(a.visible ? i : j))
  ...
  xb.prototype = {
    ...
    showLoading: function (a) {
      var b = this.options,
        c = this.loadingDiv,
        d = b.loading;
      if (!c) (this.loadingDiv = c = U(Ca, { className: "highcharts-loading" }, s(d.style, { zIndex: 10, display: S }), this.container)), (this.loadingSpan = U("span", null, d.labelStyle, c));
      this.loadingSpan.innerHTML = a || b.lang.loading;
      if (!this.loadingShown)
        L(c, { opacity: 0, display: "", left: this.plotLeft + "px", top: this.plotTop + "px", width: this.plotWidth + "px", height: this.plotHeight + "px" }),
          Ab(c, { opacity: d.style.opacity }, { duration: d.showDuration || 0 }),
          (this.loadingShown = !0);
    },
    ...
    getContainer: function () {
      ...
      this.container = a = U(
        ...
        s({ position: "relative", overflow: "hidden", width: c + "px", height: d + "px", textAlign: "left", lineHeight: "normal", zIndex: 0, "-webkit-tap-highlight-color": "rgba(0,0,0,0)" }, b.style),
    ...
    drawChartBox: function () {
      ...
      if (k) f ? f.animate(u) : (this.plotBackground = b.rect(q, p, n, r, 0).attr({ fill: k }).add().shadow(a.plotShadow));
    ...
    isReadyToRender: function () {
      var a = this;
      return (!Z && N == N.top && z.readyState !== "complete") || ($ && !N.canvg)
        ? ($
            ? Tb.push(function () {
                a.firstRender();
  ...
  Q.prototype = {
    ...
    setData: function (a, b) {
      ...
      if (i && m > i) {
        ...
        if (qa(f)) {
          ...
          if (o) for (i = 0; i < m; i++) (d = a[i]), (j[i] = d[0]), (k[i] = d.slice(1, o + 1));
    ...
    setStackedPoints: function () {
      if (this.options.stacking && !(this.visible !== !0 && this.chart.options.chart.ignoreHiddenSeries !== !1)) {
        ...
        for (q = 0; q < c; q++) {
          ...
          typeof n === "number" && !l[g] && (l[g] = { dataMin: n, dataMax: n });
          j[o] || (j[o] = {});
      ...
      if (!t(d) || !t(c)) {
        for (b = 0; b < i; b++)
          if (((o = g[b]), (f = h[b]), (e = f !== null && f !== v && (!a.isLog || f.length || f > 0)), (o = this.getExtremesFromAll || this.cropped || ((g[b + 1] || o) >= m && (g[b - 1] || o) <= l)), e && o))
            if ((e = f.length)) for (; e--; ) f[e] !== null && (j[k++] = f[e]);
            else j[k++] = f;
        d = p(d, Ia(j));
        c = p(c, ua(j));
      }
    ...
    translate: function () {
      ...
      this.generatePoints();
      for (
        var a = this.options, b = a.stacking, c = this.xAxis, d = c.categories, e = this.yAxis, f = this.points, g = f.length, h = !!this.modifyValue, i = a.pointPlacement, j = i === "between" || qa(i), k = a.threshold, a = 0;
        a < g;
        a++
      ) {
        var l = f[a],
    ...
    animate: function (a) {
      ...
      if (a)
        (a = c[h]),
          (e = c[h + "m"]),
          a || ((c[h] = a = d.clipRect(s(f, { width: 0 }))), (c[h + "m"] = e = d.clipRect(-99, g ? -c.plotLeft : -c.plotTop, 99, g ? c.chartWidth : c.chartHeight))),
          b.group.clip(a),
        ...
        for (f = b.length; f--; )
          if (((g = b[f]), (d = P(g.plotX)), (e = g.plotY), (k = g.graphic), (i = g.marker || {}), (a = (l.enabled && i.enabled === v) || i.enabled), (m = c.isInsidePlot(u(d), e, c.inverted)), a && e !== v && !isNaN(e) && g.y !== null))
            if (((a = g.pointAttr[g.selected ? "select" : ""]), (h = a.r), (i = p(i.symbol, this.symbol)), (j = i.indexOf("url") === 0), k))
              k.attr({ visibility: m ? (Z ? "inherit" : "visible") : "hidden" }).animate(s({ x: d - h, y: e - h }, k.symbolName ? { width: 2 * h, height: 2 * h } : {}));
            else {
              if (m && (h > 0 || j))
    ...
    alignDataLabel: function (a, b, c, d, e) {
      var f = this.chart,
        ...
        i = p(a.plotY, -999),
        a = b.getBBox(),
        d = s({ x: g ? f.plotWidth - i : h, y: u(g ? f.plotHeight - h : i), width: 0, height: 0 }, d);
    ...
    getSegments: function () {
      ...
      if (this.options.stacking && !this.cropped) {
        ...
        n(c, function (a) {
          g[a]
            ? b.push(g[a])
            : ((h = d.translate(a)), (k = f[a].percent ? (f[a].total ? (f[a].cum * 100) / f[a].total : 0) : f[a].cum), (i = e.toPixels(k, !0)), b.push({ y: null, plotX: h, clientX: h, plotY: i, yBottom: i, onMouseOver: ya }));
        });
        b.length && a.push(b);
      ...
      n(f, function (d) {
        ...
        f
          ...
          : (a[e] = a.chart.renderer
              .path(b)
              .attr({ fill: p(d[2], pa(d[1]).setOpacity(p(c.fillOpacity, 0.75)).get()), zIndex: 0 })
              .add(a.group));
      });
    },
  ...
  D = ha(Q, {
    ...
    animate: function (a) {
      ...
      if (Z)
        a
          ? ((e.scaleY = 0.001), (a = C(b.pos + b.len, r(b.pos, b.toPixels(c.threshold)))), d ? (e.translateX = a - b.len) : (e.translateY = a), this.group.attr(e))
  ...
  X = {
    ...
    translate: function (a) {
      ...
      var b = 0,
        ...
        g,
        h,
        i = (this.startAngleRad = (Ma / 180) * (((c.startAngle || 0) % 360) - 90)),
        j = this.points,
        k = 2 * Ma,
        ...
        for (I = 2; I--; ) {
          ...
          for (B = 0; B < J; B++) {
            ...
            if (this.options.size === null)
              (w = s.width), z - w < f ? (C[3] = r(u(w - z + f), C[3])) : z + w > h - f && (C[1] = r(u(z + w - h + f), C[1])), E - x / 2 < 0 ? (C[0] = r(u(-E + x / 2), C[0])) : E + x / 2 > d && (C[2] = r(u(E + x / 2 - d), C[2]));
          }
        }
                  ...
                  (G = s._attr.visibility),
                    ...
                    i
                      ...
                      : (b.connector = i =
                          a.chart.renderer
                            .path(j)
                            .attr({ "stroke-width": g, stroke: e.connectorColor || b.color || "#606060", visibility: G })
                            .add(a.group));
