		...
		<div id="content">
			...
			<br />
				<legend><h3>Vision</h3></legend>
					<h4 style="text-indent:60px;">Demis, the company that inspire, motivate, and give determination to the sports enthusiast.</h4>
			<br />
	...
	<div id="footer">
		<div class="foot">
			...
			<div id="foot">
				<h4>Links</h4>
					<ul>
						<a href="http://www.facebook.com/Demis"><li>Facebook</li></a>
						<a href="http://www.twitter.com/Demis"><li>Twitter</li></a>
						<a href="http://www.pinterest.com/Demis"><li>Pinterest</li></a>
						<a href="http://www.tumblr.com/Demis"><li>Tumblr</li></a>
					</ul>
			</div>
	</div>
</body>
